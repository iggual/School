...
___Another interesting thing that i discovered with experimenting with system prompts is that system prompts define boundaries similar to culture. Even if you don't explicitly define  what you should or shouldn't do, system prompt somehow define 'invisible rules' of accepted behavior.___
