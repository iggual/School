...
Use double tildes (~~) to strike through text. Perfect for ~saying~ unsaying things.
...
Use an exclamation mark (!), followed by alt text in square brackets ([]) and the image URL in parentheses (()). Show, don't tell.
